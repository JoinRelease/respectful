...
RSpec.describe CremationPlan do
  ...
  describe '#addressable association' do
    ...
    context '#service_space_address association' do
      ...
      it 'is not equal to other addressable associations' do
        service_space_address = @cremation_plan.service_space_address
        ash_storage = @cremation_plan.ash_storage_address
        ash_delivery = @cremation_plan.ash_delivery_address
        expect(service_space_address).not_to eq(ash_storage)
        expect(ash_storage).not_to eq(ash_delivery)
      end
    end

    context '#ash_storage_address association' do
    ...
    context '#ash_delivery_address association' do
